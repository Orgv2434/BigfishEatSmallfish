...
namespace TripoForUnity
{
    public class TripoController : MonoBehaviour
    {
        ...
        //v1.1
        public void OnImageToModelGenerate()
        {
            GetComponent<TripoRuntimeCore>().SetAPIKey(myApiKey);
            GetComponent<TripoRuntimeCore>().SetImagePath(GetComponent<SketchDemo>().currentImagePath).ImageToModel();
        }
